"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_multiwrap-e98ebc30_browser_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/multiwrap-e98ebc30.browser.esm.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/multiwrap-e98ebc30.browser.esm.js ***!
  \*******************************************************************************/
...
/* harmony import */ var _hasERC20Allowance_ca5e8560_browser_esm_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./hasERC20Allowance-ca5e8560.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/hasERC20Allowance-ca5e8560.browser.esm.js");
 ...
 * @beta
 */
class Multiwrap extends _erc_721_standard_82fdd228_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.S {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
     ...
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "wrap", /* @__PURE__ */(0,_contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d6)(async (contents, wrappedTokenMetadata, recipientAddress) => {
      const uri = await (0,_contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dz)(wrappedTokenMetadata, this.storage);
      const recipient = await (0,_contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cs)(recipientAddress ? recipientAddress : await this.contractWrapper.getSignerAddress());
     ...
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "unwrap", /* @__PURE__ */(0,_contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d6)(async (wrappedTokenId, recipientAddress) => {
      const recipient = await (0,_contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cs)(recipientAddress ? recipientAddress : await this.contractWrapper.getSignerAddress());
      return _contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aV.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "unwrap",
    ...
    this.metadata = new _contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ag(this.contractWrapper, _contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dx, this.storage);
    ...
    this.roles = new _contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ah(this.contractWrapper, Multiwrap.contractRoles);
  ...
  async getWrappedContents(wrappedTokenId) {
    ...
    for (const token of wrappedTokens) {
      switch (token.tokenType) {
        case 0:
          {
            const tokenMetadata = await (0,_contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bc)(this.contractWrapper.getProvider(), token.assetContract);
            erc20Tokens.push({
  ...
  async toTokenStructList(contents) {
    ...
    if (contents.erc20Tokens) {
      for (const erc20 of contents.erc20Tokens) {
        const normalizedQuantity = await (0,_contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bb)(provider, erc20.quantity, erc20.contractAddress);
        const hasAllowance = await (0,_hasERC20Allowance_ca5e8560_browser_esm_js__WEBPACK_IMPORTED_MODULE_11__.h)(this.contractWrapper, erc20.contractAddress, normalizedQuantity);
        if (!hasAllowance) {
...
(0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(Multiwrap, "contractRoles", _contract_publisher_c57d81de_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dy);
