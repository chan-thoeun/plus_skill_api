"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_split-a16b072e_browser_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/split-a16b072e.browser.esm.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/split-a16b072e.browser.esm.js ***!
  \***************************************************************************/
...
class Split {
  ...
  constructor(network, address, storage) {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "withdraw", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async walletAddress => {
      return _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "release(address)",
        args: [await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cN)(walletAddress)]
      });
    }));
    /**
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "withdrawToken", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async (walletAddress, tokenAddress) => {
      return _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "release(address,address)",
        args: [await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cN)(tokenAddress), await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cN)(walletAddress)]
      });
    }));
    /**
     * Distribute Funds
     ...
     * ```
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "distribute", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async () => {
      return _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "distribute()",
        args: []
     ...
     * @param tokenAddress - The address of the currency contract to distribute funds
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "distributeToken", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async tokenAddress => {
      return _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "distribute(address)",
        args: [await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cN)(tokenAddress)]
      });
    }));
    ...
    this.metadata = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ai(this.contractWrapper, _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dR, this.storage);
    ...
    this.roles = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aj(this.contractWrapper, Split.contractRoles);
  ...
  async balanceOfTokenAllRecipients(tokenAddress) {
    const resolvedToken = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cN)(tokenAddress);
    const recipients = await this.getAllRecipients();
    const balances = {};
    for (const recipient of recipients) {
  ...
  async balanceOf(address) {
    const resolvedAddress = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cN)(address);
  ...
  async balanceOfToken(walletAddress, tokenAddress) {
    const resolvedToken = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cN)(tokenAddress);
    const resolvedWallet = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cN)(walletAddress);
    ...
    return await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.c0)(this.contractWrapper.getProvider(), resolvedToken, value);
  }
  ...
  async _pendingPayment(address, totalReceived, alreadyReleased) {
    const addressReceived = totalReceived.mul(await this.contractWrapper.readContract.shares(await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cN)(address)));
