"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_marketplace-a10f0cdb_browser_esm_js"],{
...
/* harmony import */ var _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./watchTransactions-0b07c8b2.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/watchTransactions-0b07c8b2.browser.esm.js");
/* harmony import */ var _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./marketplace-auction-ac9e085f.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/marketplace-auction-ac9e085f.browser.esm.js");
...
class Marketplace {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.c$(network, address, abi, options);
    ...
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "direct", void 0);
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "auction", void 0);
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "_chainId", void 0);
    /**
     * @internal
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "getAll", this.getAllListings);
    /** ******************************
     * WRITE FUNCTIONS
     *******************************/
    /**
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "buyoutListing", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async (listingId, quantityDesired, receiver) => {
      const listing = await this.contractWrapper.readContract.listings(listingId);
      if (listing.listingId.toString() !== listingId.toString()) {
        throw new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bf(this.getAddress(), listingId.toString());
      }
      switch (listing.listingType) {
        case _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Direct:
          {
        ...
        case _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction:
          {
     ...
     * ```
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "makeOffer", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async (listingId, pricePerToken, quantity) => {
      const listing = await this.contractWrapper.readContract.listings(listingId);
      if (listing.listingId.toString() !== listingId.toString()) {
        throw new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bf(this.getAddress(), listingId.toString());
      }
        ...
        case _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Direct:
          {
            ...
            return await this.direct.makeOffer.prepare(listingId, quantity, (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bT)(listing.currency) ? _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cg[chainId].wrapped.address : listing.currency, pricePerToken);
          }
        case _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction:
          {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "setBidBufferBps", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async bufferBps => {
      ...
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "setTimeBufferInSeconds", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async bufferInSeconds => {
      await this.roles.verify(["admin"], await this.contractWrapper.getSignerAddress());
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "allowListingFromSpecificAssetOnly", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async contractAddress => {
      const encoded = [];
      const members = await this.roles.get("asset");
      if (members.includes(ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero)) {
        encoded.push(this.encoder.encode("revokeRole", [(0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bq)("asset"), ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero]));
      }
      encoded.push(this.encoder.encode("grantRole", [(0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bq)("asset"), contractAddress]));
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "multicall",
        args: [encoded]
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "allowListingFromAnyAsset", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async () => {
      const encoded = [];
      const members = await this.roles.get("asset");
      for (const addr in members) {
        encoded.push(this.encoder.encode("revokeRole", [(0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bq)("asset"), addr]));
      }
      encoded.push(this.encoder.encode("grantRole", [(0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bq)("asset"), ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero]));
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "multicall",
        args: [encoded]
    ...
    this.abi = _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.e.parse(abi || []);
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.metadata = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ai(this.contractWrapper, _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d2, this.storage);
    this.app = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aW(this.contractWrapper, this.metadata, this.storage);
    this.roles = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aj(this.contractWrapper, Marketplace.contractRoles);
    this.encoder = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ah(this.contractWrapper);
    this.estimator = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aO(this.contractWrapper);
    this.direct = new _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.M(this.contractWrapper, this.storage);
    this.auction = new _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.a(this.contractWrapper, this.storage);
    this.events = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aP(this.contractWrapper);
    this.platformFees = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aR(this.contractWrapper);
    this.interceptor = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aQ(this.contractWrapper);
  }
  ...
  async getListing(listingId) {
    const listing = await this.contractWrapper.readContract.listings(listingId);
    if (listing.assetContract === ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero) {
      throw new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bf(this.getAddress(), listingId.toString());
    }
    switch (listing.listingType) {
      case _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction:
  ...
  async getActiveListings(filter) {
    ...
    return filtered.filter(l => {
      return l.type === _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction && ethers__WEBPACK_IMPORTED_MODULE_11__.BigNumber.from(l.endTimeInEpochSeconds).gt(now) && ethers__WEBPACK_IMPORTED_MODULE_11__.BigNumber.from(l.startTimeInEpochSeconds).lte(now) || l.type === _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Direct && l.quantity > 0;
    });
  }
  ...
  async isRestrictedToListerRoleOnly() {
    const anyoneCanList = await this.contractWrapper.readContract.hasRole((0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bq)("lister"), ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero);
  ...
  async getOffers(listingId) {
    ...
    return await Promise.all(listingEvents.map(async e => {
      return await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cV)(this.contractWrapper.getProvider(), ethers__WEBPACK_IMPORTED_MODULE_11__.BigNumber.from(listingId), {
  ...
  async getAllListingsNoFilter(filterInvalidListings) {
    const listings = await Promise.all(Array.from(Array((await this.contractWrapper.readContract.totalListings()).toNumber()).keys()).map(async i => {
      ...
      try {
        ...
        if (err instanceof _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bf) {
          return undefined;
        } else {
      ...
      if (listing.type === _marketplace_auction_ac9e085f_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction) {
        return listing;
      }
  ...
  applyFilter(listings, filter) {
    ...
    const count = ethers__WEBPACK_IMPORTED_MODULE_11__.BigNumber.from(filter?.count || _QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.c).toNumber();
    if (filter) {
      if (filter.seller) {
...
(0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(Marketplace, "contractRoles", ["admin", "lister", "asset"]);
