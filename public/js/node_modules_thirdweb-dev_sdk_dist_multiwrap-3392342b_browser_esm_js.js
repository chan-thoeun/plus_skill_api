"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_multiwrap-3392342b_browser_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/multiwrap-3392342b.browser.esm.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/multiwrap-3392342b.browser.esm.js ***!
  \*******************************************************************************/
 ...
 * @beta
 */
class Multiwrap extends _erc_721_standard_c5f94418_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.S {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "wrap", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.dt)(async (contents, wrappedTokenMetadata, recipientAddress) => {
      const uri = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.dL)(wrappedTokenMetadata, this.storage);
      const recipient = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cN)(recipientAddress ? recipientAddress : await this.contractWrapper.getSignerAddress());
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "unwrap", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.dt)(async (wrappedTokenId, recipientAddress) => {
      const recipient = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cN)(recipientAddress ? recipientAddress : await this.contractWrapper.getSignerAddress());
      return _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "unwrap",
    ...
    this.metadata = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.ai(this.contractWrapper, _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.dK, this.storage);
    ...
    this.roles = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aj(this.contractWrapper, Multiwrap.contractRoles);
  ...
  async getWrappedContents(wrappedTokenId) {
    ...
    for (const token of wrappedTokens) {
      switch (token.tokenType) {
        case 0:
          {
            const tokenMetadata = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.b$)(this.contractWrapper.getProvider(), token.assetContract);
            erc20Tokens.push({
  ...
  async toTokenStructList(contents) {
    ...
    if (contents.erc20Tokens) {
      for (const erc20 of contents.erc20Tokens) {
        const normalizedQuantity = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.b_)(provider, erc20.quantity, erc20.contractAddress);
        const hasAllowance = await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.c3)(this.contractWrapper, erc20.contractAddress, normalizedQuantity);
        if (!hasAllowance) {
