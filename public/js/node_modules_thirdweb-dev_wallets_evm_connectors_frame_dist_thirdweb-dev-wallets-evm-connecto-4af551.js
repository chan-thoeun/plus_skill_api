...
/* harmony import */ var _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../dist/errors-4bdf81d2.browser.esm.js */ "./node_modules/@thirdweb-dev/wallets/dist/errors-4bdf81d2.browser.esm.js");
/* harmony import */ var eventemitter3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! eventemitter3 */ "./node_modules/eventemitter3/index.mjs");
...
class FrameConnector extends _dist_WagmiConnector_60b19604_browser_esm_js__WEBPACK_IMPORTED_MODULE_1__.W {
  ...
  async connect(config) {
    try {
      ...
      if (!provider) {
        throw new _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__.a();
      }
      this.setupListeners();
      this.emit("message", {
        type: "connecting"
      ...
      if (this.isUserRejectedRequestError(error)) {
        throw new _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__.U(error);
      }
      if (error.code === -32002) {
        throw new _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__.R(error);
      }
      throw error;
    }
  }
  ...
  async switchChain(chainId) {
    ...
    try {
      ...
      if (!chain) {
        throw new _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__.C({
          chainId,
          connectorId: this.id
        });
      }
      ...
      if (switchChainError.code === 4902) {
        try {
          ...
          if (currentChainId !== chainId) {
            throw new _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__.U(new Error("User rejected switch after adding network."));
          }
          return chain;
        } catch (addChainError) {
          // if user rejects request to add chain
          if (this.isUserRejectedRequestError(addChainError)) {
            throw new _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__.U(addChainError);
          }

          // else other error
          throw new _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__.A(addChainError.message);
        }
      }

      // if user rejects request to switch chain
      if (this.isUserRejectedRequestError(switchChainError)) {
        throw new _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__.U(switchChainError);
      }

      // else other error
      throw new _dist_errors_4bdf81d2_browser_esm_js__WEBPACK_IMPORTED_MODULE_6__.S(switchChainError);
    }
  }
