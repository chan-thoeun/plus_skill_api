"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_pack-767e610f_browser_esm_js"],{
...
/* harmony import */ var _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./watchTransactions-0b07c8b2.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/watchTransactions-0b07c8b2.browser.esm.js");
/* harmony import */ var _erc_1155_standard_a13e5dfb_browser_esm_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./erc-1155-standard-a13e5dfb.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/erc-1155-standard-a13e5dfb.browser.esm.js");
...
const CommonWrappableSchema = zod__WEBPACK_IMPORTED_MODULE_8__.z.object({
  contractAddress: _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.ab
});
...
const ERC721WrappableSchema = CommonWrappableSchema.extend({
  tokenId: _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.a8
});
...
const ERC1155WrappableSchema = CommonWrappableSchema.extend({
  tokenId: _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.a8,
  quantity: _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.a8
});
...
const ERC1155RewardSchema = ERC1155WrappableSchema.omit({
  ...
  quantityPerReward: _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.a8
});
...
const ERC20RewardContentsSchema = ERC20RewardSchema.extend({
  totalRewards: _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.a8["default"]("1")
});
...
const PackMetadataInputSchema = PackRewardsOutputSchema.extend({
  ...
  rewardsPerPack: _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.a8["default"]("1"),
  openStartTime: _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.ac["default"](new Date())
});
...
class PackVRF {
  constructor(network, address, storage, options, chainId) {
    var _this = this;
    let contractWrapper = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.c$(network, address, _thirdweb_dev_contracts_js_dist_abis_IPackVRFDirect_json__WEBPACK_IMPORTED_MODULE_11__, options);
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "featureName", _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.db.name);
     ...
     * @twfeature PackVRF
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "open", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cT)(async function (tokenId) {
      let amount = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
      let gasLimit = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 500000;
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aU.fromContractWrapper({
     ...
     * @twfeature PackVRF
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "claimRewards", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cT)(async function () {
    ...
    this.events = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aP(this.contractWrapper);
  }
  ...
  async parseRewards(rewards) {
    ...
    for (const reward of rewards) {
      switch (reward.tokenType) {
        case 0:
          {
            const tokenMetadata = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.bW)(this.contractWrapper.getProvider(), reward.assetContract);
            erc20Rewards.push({
  ...
  async canClaimRewards(claimerAddress) {
    const address = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cU)(claimerAddress || (await this.contractWrapper.getSignerAddress()));
  ...
  getLinkContract() {
    const linkAddress = _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.ci[this.chainId];
    if (!linkAddress) {
      throw new Error(`No LINK token address found for chainId ${this.chainId}`);
    }
    const contract = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.c$(this.contractWrapper.getSignerOrProvider(), linkAddress, _thirdweb_dev_contracts_js_dist_abis_ERC20_json__WEBPACK_IMPORTED_MODULE_14__, this.contractWrapper.options);
    return new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.ap(contract, this.storage, this.chainId);
  }
}
 ...
 * @public
 */
class Pack extends _erc_1155_standard_a13e5dfb_browser_esm_js__WEBPACK_IMPORTED_MODULE_15__.S {
  /**
   * Configure royalties
   ...
   */
  get vrf() {
    return (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.bN)(this._vrf, _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.db);
  }
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.c$(network, address, abi, options.gasless && "openzeppelin" in options.gasless ? {
      ...options,
      gasless: {
        ...options.gasless,
        openzeppelin: {
     ...
     * ```
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "create", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cT)(async metadataWithRewards => {
     ...
     * ```
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "addPackContents", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cT)(async (packId, packContents) => {
      const signerAddress = await this.contractWrapper.getSignerAddress();
     ...
     * ```
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "createTo", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cT)(async (to, metadataWithRewards) => {
      const uri = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.d7)(metadataWithRewards.packMetadata, this.storage);
      ...
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "createPack",
        args: [contents, numOfRewardUnits, uri, parsedMetadata.openStartTime, parsedMetadata.rewardsPerPack, await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cU)(to)],
        parse: receipt => {
        ...
        parse: async receipt => {
          ...
          for (const reward of rewards) {
            switch (reward.tokenType) {
              case 0:
                {
                  const tokenMetadata = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.bW)(_this.contractWrapper.getProvider(), reward.assetContract);
                  erc20Rewards.push({
                    contractAddress: reward.assetContract,
                    quantityPerReward: ethers__WEBPACK_IMPORTED_MODULE_13__.formatUnits(reward.totalAmount, tokenMetadata.decimals).toString()
                  });
    ...
    this.abi = _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.e.parse(abi || []);
    this.metadata = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.ai(this.contractWrapper, _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.dc, this.storage);
    this.app = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aW(this.contractWrapper, this.metadata, this.storage);
    this.roles = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aj(this.contractWrapper, Pack.contractRoles);
    this.royalties = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.ak(this.contractWrapper, this.metadata);
    this.encoder = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.ah(this.contractWrapper);
    this.estimator = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aO(this.contractWrapper);
    this.events = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aP(this.contractWrapper);
    this.interceptor = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aQ(this.contractWrapper);
    this.owner = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aT(this.contractWrapper);
  ...
  async isTransferRestricted() {
    const anyoneCanTransfer = await this.contractWrapper.readContract.hasRole((0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.bq)("transfer"), ethers__WEBPACK_IMPORTED_MODULE_16__.AddressZero);
  ...
  async toPackContentArgs(metadataWithRewards) {
    ...
    for (const erc20 of erc20Rewards) {
      const normalizedQuantity = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.bV)(provider, erc20.quantityPerReward, erc20.contractAddress);
      ...
      const hasAllowance = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.b_)(this.contractWrapper, erc20.contractAddress, totalQuantity);
      if (!hasAllowance) {
    ...
    for (const erc721 of erc721Rewards) {
      const isApproved = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cX)(this.contractWrapper.getProvider(), this.getAddress(), erc721.contractAddress, erc721.tokenId, owner);
      if (!isApproved) {
    ...
    for (const erc1155 of erc1155Rewards) {
      const isApproved = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cX)(this.contractWrapper.getProvider(), this.getAddress(), erc1155.contractAddress, erc1155.tokenId, owner);
      if (!isApproved) {
  ...
  detectVrf() {
    if ((0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.bO)(this.contractWrapper, "PackVRF")) {
