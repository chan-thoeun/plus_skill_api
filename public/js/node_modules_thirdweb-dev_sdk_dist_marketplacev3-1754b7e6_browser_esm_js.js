"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_marketplacev3-1754b7e6_browser_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/marketplacev3-1754b7e6.browser.esm.js":
/*!***********************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/marketplacev3-1754b7e6.browser.esm.js ***!
  \***********************************************************************************/
...
class MarketplaceV3 {
   ...
   */
  get directListings() {
    return (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bM)(this.detectDirectListings(), _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d2);
  }
  /**
   * Auctions
   ...
   */
  get englishAuctions() {
    return (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bM)(this.detectEnglishAuctions(), _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d3);
  }
   ...
   */
  get offers() {
    return (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bM)(this.detectOffers(), _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d4);
  }
  get chainId() {
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ai(this.contractWrapper, MarketplaceV3.contractRoles);
  ...
  detectDirectListings() {
    if ((0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bN)(this.contractWrapper, "DirectListings")) {
      return new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aJ(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectEnglishAuctions() {
    if ((0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bN)(this.contractWrapper, "EnglishAuctions")) {
      return new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aK(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectOffers() {
    if ((0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bN)(this.contractWrapper, "Offers")) {
      return new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aL(this.contractWrapper, this.storage);
    }
    return undefined;
  }
}
