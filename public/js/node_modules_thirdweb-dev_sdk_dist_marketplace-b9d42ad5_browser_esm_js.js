"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_marketplace-b9d42ad5_browser_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/marketplace-b9d42ad5.browser.esm.js":
/*!*********************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/marketplace-b9d42ad5.browser.esm.js ***!
  \*********************************************************************************/
...
/* harmony import */ var _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./marketplace-auction-b0434ddf.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/marketplace-auction-b0434ddf.browser.esm.js");
...
class Marketplace {
  ...
  constructor(network, address, storage) {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "buyoutListing", (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cS)(async (listingId, quantityDesired, receiver) => {
      const listing = await this.contractWrapper.readContract.listings(listingId);
      if (listing.listingId.toString() !== listingId.toString()) {
        throw new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.be(this.getAddress(), listingId.toString());
      }
      switch (listing.listingType) {
        case _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Direct:
          {
        ...
        case _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction:
          {
     ...
     * ```
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "makeOffer", (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cS)(async (listingId, pricePerToken, quantity) => {
      const listing = await this.contractWrapper.readContract.listings(listingId);
      if (listing.listingId.toString() !== listingId.toString()) {
        throw new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.be(this.getAddress(), listingId.toString());
      }
        ...
        case _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Direct:
          {
            ...
            return await this.direct.makeOffer.prepare(listingId, quantity, (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bS)(listing.currency) ? _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cf[chainId].wrapped.address : listing.currency, pricePerToken);
          }
        case _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction:
          {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "setBidBufferBps", (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cS)(async bufferBps => {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "setTimeBufferInSeconds", (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cS)(async bufferInSeconds => {
      await this.roles.verify(["admin"], await this.contractWrapper.getSignerAddress());
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "allowListingFromSpecificAssetOnly", (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cS)(async contractAddress => {
      const encoded = [];
      const members = await this.roles.get("asset");
      if (members.includes(ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero)) {
        encoded.push(this.encoder.encode("revokeRole", [(0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bp)("asset"), ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero]));
      }
      encoded.push(this.encoder.encode("grantRole", [(0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bp)("asset"), contractAddress]));
      return _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aT.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "multicall",
        args: [encoded]
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "allowListingFromAnyAsset", (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cS)(async () => {
      const encoded = [];
      const members = await this.roles.get("asset");
      for (const addr in members) {
        encoded.push(this.encoder.encode("revokeRole", [(0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bp)("asset"), addr]));
      }
      encoded.push(this.encoder.encode("grantRole", [(0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bp)("asset"), ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero]));
      return _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aT.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "multicall",
        args: [encoded]
    ...
    this.metadata = new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ah(this.contractWrapper, _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d1, this.storage);
    ...
    this.roles = new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ai(this.contractWrapper, Marketplace.contractRoles);
    ...
    this.direct = new _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.M(this.contractWrapper, this.storage);
    this.auction = new _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.a(this.contractWrapper, this.storage);
    this.events = new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aO(this.contractWrapper);
    this.platformFees = new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aQ(this.contractWrapper);
  ...
  async getActiveListings(filter) {
    ...
    return filtered.filter(l => {
      return l.type === _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction && ethers__WEBPACK_IMPORTED_MODULE_11__.BigNumber.from(l.endTimeInEpochSeconds).gt(now) && ethers__WEBPACK_IMPORTED_MODULE_11__.BigNumber.from(l.startTimeInEpochSeconds).lte(now) || l.type === _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Direct && l.quantity > 0;
    });
  }
  ...
  async isRestrictedToListerRoleOnly() {
    const anyoneCanList = await this.contractWrapper.readContract.hasRole((0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bp)("lister"), ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero);
  ...
  async getOffers(listingId) {
    ...
    return await Promise.all(listingEvents.map(async e => {
      return await (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(this.contractWrapper.getProvider(), ethers__WEBPACK_IMPORTED_MODULE_11__.BigNumber.from(listingId), {
  ...
  async getAllListingsNoFilter(filterInvalidListings) {
    const listings = await Promise.all(Array.from(Array((await this.contractWrapper.readContract.totalListings()).toNumber()).keys()).map(async i => {
      ...
      try {
        ...
        if (err instanceof _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.be) {
          return undefined;
        } else {
      ...
      if (listing.type === _marketplace_auction_b0434ddf_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction) {
        return listing;
      }
