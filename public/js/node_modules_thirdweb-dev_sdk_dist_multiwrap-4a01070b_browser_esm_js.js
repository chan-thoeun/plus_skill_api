"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_multiwrap-4a01070b_browser_esm_js"],{
 ...
 * @beta
 */
class Multiwrap extends _erc_721_standard_4576c134_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.S {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "wrap", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cT)(async (contents, wrappedTokenMetadata, recipientAddress) => {
      const uri = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.d7)(wrappedTokenMetadata, this.storage);
      const recipient = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cU)(recipientAddress ? recipientAddress : await this.contractWrapper.getSignerAddress());
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__._)(this, "unwrap", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cT)(async (wrappedTokenId, recipientAddress) => {
      const recipient = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.cU)(recipientAddress ? recipientAddress : await this.contractWrapper.getSignerAddress());
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "unwrap",
    ...
    this.metadata = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.ai(this.contractWrapper, _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.d6, this.storage);
    ...
    this.roles = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.aj(this.contractWrapper, Multiwrap.contractRoles);
  ...
  async getWrappedContents(wrappedTokenId) {
    ...
    for (const token of wrappedTokens) {
      switch (token.tokenType) {
        case 0:
          {
            const tokenMetadata = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.bW)(this.contractWrapper.getProvider(), token.assetContract);
            erc20Tokens.push({
  ...
  async toTokenStructList(contents) {
    ...
    if (contents.erc20Tokens) {
      for (const erc20 of contents.erc20Tokens) {
        const normalizedQuantity = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.bV)(provider, erc20.quantity, erc20.contractAddress);
        const hasAllowance = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__.b_)(this.contractWrapper, erc20.contractAddress, normalizedQuantity);
        if (!hasAllowance) {
