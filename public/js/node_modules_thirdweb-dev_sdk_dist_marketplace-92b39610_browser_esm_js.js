"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_marketplace-92b39610_browser_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/marketplace-92b39610.browser.esm.js":
/*!*********************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/marketplace-92b39610.browser.esm.js ***!
  \*********************************************************************************/
...
/* harmony import */ var _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./custom-fe0942b4.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/custom-fe0942b4.browser.esm.js");
/* harmony import */ var _marketplace_auction_2da61082_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./marketplace-auction-2da61082.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/marketplace-auction-2da61082.browser.esm.js");
...
class Marketplace {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dD(network, address, abi, options);
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "buyoutListing", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async (listingId, quantityDesired, receiver) => {
      const listing = await this.contractWrapper.readContract.listings(listingId);
      if (listing.listingId.toString() !== listingId.toString()) {
        throw new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bg(this.getAddress(), listingId.toString());
      }
      switch (listing.listingType) {
        case _marketplace_auction_2da61082_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Direct:
          {
        ...
        case _marketplace_auction_2da61082_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction:
          {
     ...
     * ```
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "makeOffer", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async (listingId, pricePerToken, quantity) => {
      const listing = await this.contractWrapper.readContract.listings(listingId);
      if (listing.listingId.toString() !== listingId.toString()) {
        throw new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bg(this.getAddress(), listingId.toString());
      }
        ...
        case _marketplace_auction_2da61082_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Direct:
          {
            ...
            return await this.direct.makeOffer.prepare(listingId, quantity, (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bY)(listing.currency) ? _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.c_[chainId].wrapped.address : listing.currency, pricePerToken);
          }
        case _marketplace_auction_2da61082_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction:
          {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "setBidBufferBps", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async bufferBps => {
      ...
      return _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "setTimeBufferInSeconds", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async bufferInSeconds => {
      await this.roles.verify(["admin"], await this.contractWrapper.getSignerAddress());
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "allowListingFromSpecificAssetOnly", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async contractAddress => {
      const encoded = [];
      const members = await this.roles.get("asset");
      if (members.includes(ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero)) {
        encoded.push(this.encoder.encode("revokeRole", [(0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bs)("asset"), ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero]));
      }
      encoded.push(this.encoder.encode("grantRole", [(0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bs)("asset"), contractAddress]));
      return _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "multicall",
        args: [encoded]
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "allowListingFromAnyAsset", (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(async () => {
      const encoded = [];
      const members = await this.roles.get("asset");
      for (const addr in members) {
        encoded.push(this.encoder.encode("revokeRole", [(0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bs)("asset"), addr]));
      }
      encoded.push(this.encoder.encode("grantRole", [(0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bs)("asset"), ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero]));
      return _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "multicall",
        args: [encoded]
    ...
    this.abi = _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.e.parse(abi || []);
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.metadata = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ai(this.contractWrapper, _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dG, this.storage);
    this.app = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aW(this.contractWrapper, this.metadata, this.storage);
    this.roles = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aj(this.contractWrapper, Marketplace.contractRoles);
    this.encoder = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ah(this.contractWrapper);
    this.estimator = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aO(this.contractWrapper);
    this.direct = new _marketplace_auction_2da61082_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.M(this.contractWrapper, this.storage);
    this.auction = new _marketplace_auction_2da61082_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.a(this.contractWrapper, this.storage);
    this.events = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aP(this.contractWrapper);
    this.platformFees = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aR(this.contractWrapper);
    this.interceptor = new _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aQ(this.contractWrapper);
  }
  ...
  async isRestrictedToListerRoleOnly() {
    const anyoneCanList = await this.contractWrapper.readContract.hasRole((0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bs)("lister"), ethers__WEBPACK_IMPORTED_MODULE_12__.AddressZero);
  ...
  async getOffers(listingId) {
    ...
    return await Promise.all(listingEvents.map(async e => {
      return await (0,_custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.du)(this.contractWrapper.getProvider(), ethers__WEBPACK_IMPORTED_MODULE_11__.BigNumber.from(listingId), {
  ...
  async getAllListingsNoFilter(filterInvalidListings) {
    const listings = await Promise.all(Array.from(Array((await this.contractWrapper.readContract.totalListings()).toNumber()).keys()).map(async i => {
      ...
      try {
        ...
        if (err instanceof _custom_fe0942b4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bg) {
          return undefined;
        } else {
      ...
      if (listing.type === _marketplace_auction_2da61082_browser_esm_js__WEBPACK_IMPORTED_MODULE_10__.L.Auction) {
        return listing;
      }
