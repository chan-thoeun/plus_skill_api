"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_vote-6af9e0c5_browser_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/vote-6af9e0c5.browser.esm.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/vote-6af9e0c5.browser.esm.js ***!
  \**************************************************************************/
...
class Vote {
  ...
  constructor(network, address, storage) {
     ...
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__._)(this, "propose", /* @__PURE__ */(0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.d3)(async (description, executions) => {
      if (!executions) {
        executions = [{
     ...
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__._)(this, "vote", /* @__PURE__ */(0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.d3)(async function (proposalId, voteType) {
     ...
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__._)(this, "execute", /* @__PURE__ */(0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.d3)(async proposalId => {
    ...
    this.metadata = new _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.ag(this.contractWrapper, _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.dC, this.storage);
  ...
  async hasVoted(proposalId, account) {
    ...
    return this.contractWrapper.readContract.hasVoted(proposalId, await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.cp)(account));
  }
  ...
  async balanceOfToken(tokenAddress) {
    const erc20 = new ethers__WEBPACK_IMPORTED_MODULE_13__.Contract(await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.cp)(tokenAddress), _thirdweb_dev_contracts_js_dist_abis_IERC20_json__WEBPACK_IMPORTED_MODULE_14__, this.contractWrapper.getProvider());
    return await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.bb)(this.contractWrapper.getProvider(), tokenAddress, await erc20.balanceOf(this.contractWrapper.readContract.address));
  }
  ...
  async settings() {
    ...
    const votingTokenMetadata = await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_7__.ba)(this.contractWrapper.getProvider(), votingTokenAddress);
    return {
