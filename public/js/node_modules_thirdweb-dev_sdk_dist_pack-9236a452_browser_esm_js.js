"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_pack-9236a452_browser_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/pack-9236a452.browser.esm.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/pack-9236a452.browser.esm.js ***!
  \**************************************************************************/
...
/* harmony import */ var _erc_1155_standard_1ef302b8_browser_esm_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./erc-1155-standard-1ef302b8.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/erc-1155-standard-1ef302b8.browser.esm.js");
...
/* harmony import */ var _hasERC20Allowance_018c98b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./hasERC20Allowance-018c98b2.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/hasERC20Allowance-018c98b2.browser.esm.js");
...
const CommonWrappableSchema = /* @__PURE__ */zod__WEBPACK_IMPORTED_MODULE_7__.z.object({
  contractAddress: _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aa
});
...
const ERC721WrappableSchema = /* @__PURE__ */CommonWrappableSchema.extend({
  tokenId: _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.a7
});
...
const ERC1155WrappableSchema = /* @__PURE__ */CommonWrappableSchema.extend({
  tokenId: _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.a7,
  quantity: _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.a7
});
...
const ERC1155RewardSchema = /* @__PURE__ */ERC1155WrappableSchema.omit({
  ...
  quantityPerReward: _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.a7
});
...
const ERC20RewardContentsSchema = /* @__PURE__ */(() => ERC20RewardSchema.extend({
  totalRewards: _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.a7.default("1")
}))();
...
const PackMetadataInputSchema = /* @__PURE__ */(() => PackRewardsOutputSchema.extend({
  ...
  rewardsPerPack: _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.a7.default("1"),
  openStartTime: _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ab.default(new Date())
}))();
...
class PackVRF {
  constructor(network, address, storage, options, chainId) {
    var _this = this;
    let contractWrapper = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : new _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.da(network, address, _thirdweb_dev_contracts_js_dist_abis_IPackVRFDirect_json__WEBPACK_IMPORTED_MODULE_10__, options);
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "featureName", _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dx.name);
     ...
     * @twfeature PackVRF
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "open", /* @__PURE__ */(0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d3)(async function (tokenId) {
     ...
     * @twfeature PackVRF
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "claimRewards", /* @__PURE__ */(0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d3)(async function () {
  ...
  async parseRewards(rewards) {
    ...
    for (const reward of rewards) {
      switch (reward.tokenType) {
        case 0:
          {
            const tokenMetadata = await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ba)(this.contractWrapper.getProvider(), reward.assetContract);
            erc20Rewards.push({
  ...
  async canClaimRewards(claimerAddress) {
    const address = await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cp)(claimerAddress || (await this.contractWrapper.getSignerAddress()));
  ...
  getLinkContract() {
    const linkAddress = _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cD[this.chainId];
    if (!linkAddress) {
      throw new Error(`No LINK token address found for chainId ${this.chainId}`);
    }
    const contract = new _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.da(this.contractWrapper.getSignerOrProvider(), linkAddress, _thirdweb_dev_contracts_js_dist_abis_ERC20_json__WEBPACK_IMPORTED_MODULE_13__, this.contractWrapper.options);
    return new _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.at(contract, this.storage, this.chainId);
  }
}
 ...
 * @public
 */
class Pack extends _erc_1155_standard_1ef302b8_browser_esm_js__WEBPACK_IMPORTED_MODULE_14__.S {
  /**
   * Configure royalties
   ...
   */
  get vrf() {
    return (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bZ)(this._vrf, _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dx);
  }
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.da(network, address, abi, options.gasless && "openzeppelin" in options.gasless ? {
      ...options,
      gasless: {
        ...options.gasless,
        openzeppelin: {
     ...
     * ```
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "create", /* @__PURE__ */(0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d3)(async metadataWithRewards => {
     ...
     * ```
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "addPackContents", /* @__PURE__ */(0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d3)(async (packId, packContents) => {
      const signerAddress = await this.contractWrapper.getSignerAddress();
     ...
     * ```
     */
    (0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "createTo", /* @__PURE__ */(0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d3)(async (to, metadataWithRewards) => {
      const uri = await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dt)(metadataWithRewards.packMetadata, this.storage);
      ...
      return _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aV.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "createPack",
        args: [contents, numOfRewardUnits, uri, parsedMetadata.openStartTime, parsedMetadata.rewardsPerPack, await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cp)(to)],
        parse: receipt => {
        ...
        parse: async receipt => {
          ...
          for (const reward of rewards) {
            switch (reward.tokenType) {
              case 0:
                {
                  const tokenMetadata = await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ba)(_this.contractWrapper.getProvider(), reward.assetContract);
                  erc20Rewards.push({
                    contractAddress: reward.assetContract,
                    quantityPerReward: ethers__WEBPACK_IMPORTED_MODULE_12__.formatUnits(reward.totalAmount, tokenMetadata.decimals).toString()
                  });
    ...
    this.metadata = new _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ag(this.contractWrapper, _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dy, this.storage);
    ...
    this.roles = new _contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ah(this.contractWrapper, Pack.contractRoles);
  ...
  async isTransferRestricted() {
    const anyoneCanTransfer = await this.contractWrapper.readContract.hasRole((0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bG)("transfer"), ethers__WEBPACK_IMPORTED_MODULE_15__.AddressZero);
  ...
  async toPackContentArgs(metadataWithRewards) {
    ...
    for (const erc20 of erc20Rewards) {
      const normalizedQuantity = await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.b9)(provider, erc20.quantityPerReward, erc20.contractAddress);
      ...
      const hasAllowance = await (0,_hasERC20Allowance_018c98b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_16__.h)(this.contractWrapper, erc20.contractAddress, totalQuantity);
      if (!hasAllowance) {
    ...
    for (const erc721 of erc721Rewards) {
      const isApproved = await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d6)(this.contractWrapper.getProvider(), this.getAddress(), erc721.contractAddress, erc721.tokenId, owner);
      if (!isApproved) {
    ...
    for (const erc1155 of erc1155Rewards) {
      const isApproved = await (0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.d6)(this.contractWrapper.getProvider(), this.getAddress(), erc1155.contractAddress, erc1155.tokenId, owner);
      if (!isApproved) {
  ...
  detectVrf() {
    if ((0,_contract_publisher_49845f13_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.b_)(this.contractWrapper, "PackVRF")) {
...
(0,_QueryParams_ca1fafc2_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(Pack, "contractRoles", ["admin", "minter", "asset", "transfer"]);
