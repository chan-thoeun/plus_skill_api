"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_split-4710e508_browser_esm_js"],{
...
class Split {
  ...
  constructor(network, address, storage) {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "withdraw", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async walletAddress => {
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        ...
        args: [await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(walletAddress)]
      });
    }));
    /**
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "withdrawToken", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async (walletAddress, tokenAddress) => {
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "release(address,address)",
        args: [await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(tokenAddress), await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(walletAddress)]
      });
    }));
    /**
     * Distribute Funds
     ...
     * ```
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "distribute", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async () => {
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "distribute()",
        args: []
     ...
     * @param tokenAddress - The address of the currency contract to distribute funds
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "distributeToken", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async tokenAddress => {
      return _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aU.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "distribute(address)",
        args: [await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(tokenAddress)]
      });
    }));
    ...
    this.metadata = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ai(this.contractWrapper, _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dd, this.storage);
    ...
    this.roles = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.aj(this.contractWrapper, Split.contractRoles);
  ...
  async balanceOfTokenAllRecipients(tokenAddress) {
    const resolvedToken = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(tokenAddress);
    const recipients = await this.getAllRecipients();
    const balances = {};
    for (const recipient of recipients) {
  ...
  async balanceOf(address) {
    const resolvedAddress = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(address);
  ...
  async balanceOfToken(walletAddress, tokenAddress) {
    const resolvedToken = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(tokenAddress);
    const resolvedWallet = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(walletAddress);
    ...
    return await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bX)(this.contractWrapper.getProvider(), resolvedToken, value);
  }
  ...
  async _pendingPayment(address, totalReceived, alreadyReleased) {
    const addressReceived = totalReceived.mul(await this.contractWrapper.readContract.shares(await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(address)));
