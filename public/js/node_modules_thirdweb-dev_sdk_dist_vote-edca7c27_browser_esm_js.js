"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_vote-edca7c27_browser_esm_js"],{

/***/ "./node_modules/@thirdweb-dev/sdk/dist/vote-edca7c27.browser.esm.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@thirdweb-dev/sdk/dist/vote-edca7c27.browser.esm.js ***!
  \**************************************************************************/
...
class Vote {
  ...
  constructor(network, address, storage) {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "propose", (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cS)(async (description, executions) => {
      if (!executions) {
        executions = [{
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "vote", (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cS)(async function (proposalId, voteType) {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "execute", (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cS)(async proposalId => {
    ...
    this.metadata = new _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ah(this.contractWrapper, _watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.df, this.storage);
  ...
  async hasVoted(proposalId, account) {
    ...
    return this.contractWrapper.readContract.hasVoted(proposalId, await (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(account));
  }
  ...
  async balanceOfToken(tokenAddress) {
    const erc20 = new ethers__WEBPACK_IMPORTED_MODULE_14__.Contract(await (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(tokenAddress), _thirdweb_dev_contracts_js_dist_abis_IERC20_json__WEBPACK_IMPORTED_MODULE_15__, this.contractWrapper.getProvider());
    return await (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bW)(this.contractWrapper.getProvider(), tokenAddress, await erc20.balanceOf(this.contractWrapper.readContract.address));
  }
  ...
  async settings() {
    ...
    const votingTokenMetadata = await (0,_watchTransactions_8ceed2d4_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bV)(this.contractWrapper.getProvider(), votingTokenAddress);
    return {
