"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_thirdweb-dev_sdk_dist_vote-8fdbd27b_browser_esm_js"],{
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ethers */ "./node_modules/@ethersproject/contracts/lib.esm/index.js");
/* harmony import */ var _Vote_3b66775c_browser_esm_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Vote-3b66775c.browser.esm.js */ "./node_modules/@thirdweb-dev/sdk/dist/Vote-3b66775c.browser.esm.js");
...
class Vote {
  ...
  constructor(network, address, storage) {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "propose", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async (description, executions) => {
      if (!executions) {
        executions = [{
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "vote", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async function (proposalId, voteType) {
     ...
     */
    (0,_QueryParams_7d9473b5_browser_esm_js__WEBPACK_IMPORTED_MODULE_9__._)(this, "execute", (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cT)(async proposalId => {
    ...
    this.metadata = new _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.ai(this.contractWrapper, _watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.dg, this.storage);
  ...
  async get(proposalId) {
    ...
    const proposals = all.filter(p => p.proposalId.eq(ethers__WEBPACK_IMPORTED_MODULE_11__.BigNumber.from(proposalId)));
  ...
  async getProposalVotes(proposalId) {
    ...
    return [{
      type: _Vote_3b66775c_browser_esm_js__WEBPACK_IMPORTED_MODULE_12__.V.Against,
      label: "Against",
      count: votes.againstVotes
    }, {
      type: _Vote_3b66775c_browser_esm_js__WEBPACK_IMPORTED_MODULE_12__.V.For,
      label: "For",
      count: votes.forVotes
    }, {
      type: _Vote_3b66775c_browser_esm_js__WEBPACK_IMPORTED_MODULE_12__.V.Abstain,
      label: "Abstain",
  ...
  async hasVoted(proposalId, account) {
    ...
    return this.contractWrapper.readContract.hasVoted(proposalId, await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(account));
  }
  ...
  async balance() {
    ...
    return {
      ...
      decimals: 18,
      value: balance,
      displayValue: ethers__WEBPACK_IMPORTED_MODULE_13__.formatUnits(balance, 18)
    };
  }
  ...
  async balanceOfToken(tokenAddress) {
    const erc20 = new ethers__WEBPACK_IMPORTED_MODULE_14__.Contract(await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.cU)(tokenAddress), _thirdweb_dev_contracts_js_dist_abis_IERC20_json__WEBPACK_IMPORTED_MODULE_15__, this.contractWrapper.getProvider());
    return await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bX)(this.contractWrapper.getProvider(), tokenAddress, await erc20.balanceOf(this.contractWrapper.readContract.address));
  }
  ...
  async settings() {
    ...
    const votingTokenMetadata = await (0,_watchTransactions_0b07c8b2_browser_esm_js__WEBPACK_IMPORTED_MODULE_8__.bW)(this.contractWrapper.getProvider(), votingTokenAddress);
    return {
