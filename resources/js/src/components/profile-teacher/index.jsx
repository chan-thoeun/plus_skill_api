...
const index = () => {
    ...
    return (
        <>
                                    ...
                                    <div className="team-details-thumb">
                                        <div className="thumbnail text-center">
                                            {userInfo?.profile?.image ? (
                                                <img src={userInfo?.profile?.image} alt="team images" />
                                            ):(null)}
                                            {image ? (
                                                <img src={image} alt="team images" />
                                            ): (
                                            ...
                                            <a onClick={() => inputRef.current.click()} class="edu-btn btn-primary btn-small mt-4">Upload Profile</a>
                                        </div>
                                        <ul className="social-share">
                                            <li><a href="#"><i className="icon-share-alt"></i></a></li>
                                            <li>
                                                <a href={`${userInfo?.profile?.facebook}`} target="_blank"><i className="icon-facebook"></i></a>
                                            </li>
                                            <li>
                                                <a href={`${userInfo?.profile?.twitter}`} target="_blank"><i className="icon-twitter"></i></a>
                                            </li>
                                            <li>
                                                <a href={`${userInfo?.profile?.linkedin}`} target="_blank"><i className="icon-linkedin2"></i></a>
                                            </li>
                                            <li>
                                                <a href={`${userInfo?.profile?.youtube}`} target="_blank"><i className="icon-youtube"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-8">
                                    <div className="team-details-content">
                                        ...
                                        <div className="contact-info">
                                            ...
                                            <ul>
                                                <li><span>Address:</span>{userInfo?.address}</li>
            ...
            {showModalUpload && <UploadImageModal showModal={showModalUpload} setShowModal={setShowModalUpload} previewImage={previewImage} setImage={setImage}/>}
        </>
    )
}
